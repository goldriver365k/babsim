/* ==========================================================================
   ...
   - 수신 번호는 아래 ROOM_INQUIRY_PHONE 한 곳에서만 관리합니다.
   ========================================================================== */

var ROOM_INQUIRY_PHONE = "01000000000"; // TODO: 실제 담당자 번호로 교체하세요.
...
var RoomInquiry = (function () {
  ...
  function launchSms(data) {
    var body = "[방 구하기 문의]\n\n"
      ...
      + "보증금: " + data.deposit + "\n"
      + "월세: " + data.monthlyRent;
    window.location.href = "sms:" + ROOM_INQUIRY_PHONE + "?body=" + encodeURIComponent(body);
  }
  ...
  function renderDoneStep() {
    ...
    els.body.innerHTML = "";
    els.body.appendChild(el("p", "room-inquiry-done-msg", tr(T.doneMessage)));
