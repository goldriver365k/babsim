...
const HOMETOWN_POPUP = {
  ...
  button: {
    ko: "나의 고향 이야기 올리기",
    en: "Share My Hometown Story",
    zh: "分享我的家乡故事",
    vi: "Đăng câu chuyện quê hương của tôi",
    mn: "Төрсөн нутгийн түүхээ нийтлэх",
    bn: "আমার নিজ শহরের গল্প পোস্ট করুন",
    my: "ကျွန်ုပ်၏ဇာတိမြို့ ဇာတ်လမ်းကို တင်ရန်"
  },
  dismissToday: {
    ko: "오늘 하루 보지 않기",
