...
const BREAKFAST_RATING_TEXT = {
  ...
  /* 모바일 UI 개선 6단계: 당일 첫 방문 평가 팝업(버튼 2개) */
  popupRateBtn: { ko: "평가하기", en: "Rate now", zh: "去评价", vi: "Đánh giá ngay", mn: "Үнэлэх", bn: "মূল্যায়ন করুন", my: "အကဲဖြတ်ရန်" },
  popupDismissBtn: { ko: "오늘은 닫기", en: "Not today", zh: "今天不用了", vi: "Hôm nay bỏ qua", mn: "Өнөөдөр хаах", bn: "আজ বন্ধ করুন", my: "ယနေ့ပိတ်ရန်" }
};
