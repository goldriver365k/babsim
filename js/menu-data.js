...
const BREAKFAST_INFO = {
  ...
  // 세부페이지 리디자인(비용 최소화)의 라벤더 히어로용 한 줄 설명 —
  // 새 이벤트/데이터가 아니라 title/price와 같은 자리에 놓이는 문구.
  heroTagline: {
    ko: "아침을 여는 가장 든든한 한 끼",
    en: "A hearty meal to start your morning",
    zh: "开启元气满满的一天",
    vi: "Bữa sáng no đủ để bắt đầu ngày mới",
    mn: "Өглөөг эрч хүчтэй эхлүүлэх хамгийн шимтэй хоол",
    bn: "সকালকে শক্তিশালীভাবে শুরু করার সবচেয়ে পরিতৃপ্তিকর খাবার",
    my: "မနက်ခင်းကို အားအင်ပြည့်ဝစွာ စတင်ဖို့ အကောင်းဆုံးအစားအစာ"
  },
